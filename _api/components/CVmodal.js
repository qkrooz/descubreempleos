  ...
  if (information_complete) {
    return (
      <Modal isOpen={cvmodal_vis} size="5xl" onClose={() => set_cvmodal_vis((cvmodal_vis) => !cvmodal_vis)}>
        ...
        <ModalContent>
          <ModalBody>
            <PDFViewer style={{ height: "50em", width: "100%" }}>
              <CVpdf userInfo={userInfo} secondaryInfo={secondaryInfo} />
            </PDFViewer>
          </ModalBody>
        </ModalContent>
      </Modal>
      ...
      //           </CVButtonAction>
      //           <CVButtonAction>
      //             <PDFDownloadLink document={<CVpdf userInfo={userInfo} secondaryInfo={secondaryInfo} />} fileName={`${userInfo.ID}_CV.pdf`}>
